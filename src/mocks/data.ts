...
export const mockCourse: Course = {
  ...
  booking_rules: null,
  required_tags: [],
  meeting_interval_mins: 60,
  meeting_duration_mins: 300,
  min_scheduling_notice_mins: 30,
  date_range_days: 30,
  pre_buffer_mins: 0,
  post_buffer_mins: 0,
...
const profiles: Record<string, MemberProfile> = {
  [MOCK_USER_ID]: {
    ...
    nonprofits: ['Boys & Girls Club', 'Surfrider Foundation'],
    linkedin_url: null,
    handicap_index: 12.5,
  ...
  [MOCK_MEMBER_3_ID]: {
    ...
    nonprofits: ['Boys & Girls Club', 'Legal Aid Society', 'Feeding San Diego'],
    linkedin_url: null,
    handicap_index: 18.0,
